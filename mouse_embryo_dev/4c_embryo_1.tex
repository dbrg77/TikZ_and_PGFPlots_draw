...
\begin{document}
    \begin{tikzpicture}
        ...
        % polar body
        \draw[thick, kgrey, fill=kgrey!50] (3,5.2) circle[radius=0.35];
        \draw[kgrey, dashed, fill=kgrey!75] (3,5.2) circle[radius = 0.125];
        
        % bottom blastomeres
        %% junctions
        \draw[thick, kviolet] (3,4.5) -- (3,3) (3,3) -- (1.7,2.25) (3,3) -- (4.3,2.25);
        %% cells
        ...
        % fill the junction colour
        \draw[draw=none, fill=kpurple!50, opacity=0.5] (3,4.5) -- (1.7,2.25) -- (4.3,2.25) -- cycle;
