...
\begin{document}
    \begin{tikzpicture}
        ...
        {
            \draw[thick, draw=kviolet, fill=kpurple!50, opacity=.5, rotate around={\x:(3,3)}] (3,4.5) circle[radius=1.5];
            \draw[draw=kviolet, inner color=white, outer color=kpurple!75, rotate around={\x:(3,3)}] (3,4.5) circle[radius=0.4];
        }
